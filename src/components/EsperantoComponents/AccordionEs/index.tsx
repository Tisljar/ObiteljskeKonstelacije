        ...
        <>
            <ul className="accordion-ul">
                <li className="accordion-li">
                    ...
                    <p>
                        ESPERANTO!!!! Potreba za pripadanjem obitelji, grupi, generaciji, susjedstvu ... je svima
                        poznata i prirodna potreba. Ali pripadanje je i pravo. Ukoliko se to pravo naruši, obiteljska
                        savjest se kroz sistemske utjecaje pobrine da svatko dobije svoje mjesto.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <ul>
                            <li>Partneri, sadašnji i bivši</li>
                            <li>Braća i sestre, ali ne i njihova djeca i partneri</li>
                            <li>Majka i otac</li>
                            <li>
                    ...
                    <p>
                        ...
                        siromaštvo, krađe ili nezasluženo stjecanje imovine, seljenje u nova mjesta stanovanja i u nove
                        kulturne zajednice.
                    </p>
                    <p>
                        Na koji se način obiteljska savjest pobrine da svi i sve pripada? Jedan od načina je da se u
                        obitelji kroz više generacija ponavljaju slični ili isti događaji. Ili se pojavljuju kao
                        sklonosti sličnim bolestima, uključujući i mentalne poremećaje. Ili neki mlađi čovjek u obitelji
                        „poprimi“ karakter nekog strica ili ujaka kojeg nikad nije upoznao. Ili osjećamo dug svoje
                        obitelji pa sebi podsvjesno sabotiramo život.
                    </p>
                    <p>
                        Najčešće nosimo potisnute emocije svojih roditelja ili predaka i slijedom toga djelomično
                        ponavljamo njihove sudbine.
                    </p>
                </li>
                <li className="accordion-li">
                    <input type="checkbox" defaultChecked={true} />
                    ...
                    <p>
                        Prvo pravilo poretka je da životna energija najbolje teče od starijih prema mlađima , zato oni
                        koji dolaze prije imaju prednost prema onima koji dolaze kasnije. <br />
                        Drugo važno pravilo je da nova obitelj ima prednost pred izvornoj obitelji. kao što biblija
                        kaže: Stoga će čovjek ostaviti oca svog i majku svoju, te prionuti uza ženu svoju, i oni će biti
                        jedno tijelo.
                        <br />
                        Uz to, svako u obitelji ima svoje mjesto i uz to mjesto povezanu ulogu. Posve je prirodno da se
                        ponekad u obitelji privremeno poremeti poredak, nakon većih osobnih bolesti ili trauma, ranih
                        smrti ili prekida partnerstva.
                    </p>
                    <p>
                ...
                <li className="accordion-li">
                    <input type="checkbox" defaultChecked={true} />
                    <i></i>
                    <h2 className="accordion-title">Ravnoteža davanja i primanja</h2>
                    <p>
                        Iako ovaj princip dio konstelatora ne smatra osnovnim principom, ovo pravilo u konstelacijama
                        ima svoju primjenu i prepliće se sa osnovnim principima pripadanja i poretka.
                    </p>
                    <p>
                        U svemu što nam se u životu događa važno je imati ravnotežu davanja i primanja:
                        <ul>
                            <li>
                                Član obitelji daje lojalnost, prihvaćanje pravila i uloga u obitelji. Od obitelji prima
                                osjećaj pripadanja, osjećaj slobode.
                            </li>
                            <li>
                                Roditelj daje život, djeca život prosljeđuju na svoj način dalje. Nema duga prema
                                roditeljima!!
                            </li>
                            <li>
                            ...
                            <li>
                                U partnerstvu nema ravnoteže u davanju i primanju!! Kada partner daje, drugi partner mu
                                uzvrati malo više od onoga što je dobio. I tako ljubav raste. Kada partner povrijedi,
                                drugi partner mu ima pravo uzvratiti ali malo manjom mjerom od onoga čime je povrijeđen.
                                Tako nema žrtve i odnos se sačuva.
                            </li>
                            <li>
                                Opraštanjem se ne dolazi do poravnanja. To je zauzimanje arogantnog stava i stvaranje
                                vječitog duga onome kome opraštaš: „Ja sam bolji od tebe i opraštam ti. Vječno mi
                                duguješ.“
                            </li>
                            <li>
                            ...
                            <li>
                                Kada nešto dobiješ{' '}
                                <ul>
                                    <li className="third-layer">ili vratiš istom mjerom onome od koga si dobio</li>
                                    <li className="third-layer">ili proslijediš nekome drugome</li>
                                    <li className="third-layer">
                                        ili ako nije moguće, poravnaš sa iskrenom zahvalnošću tako da nema duga.
                                    </li>
                                </ul>
                            </li>
                            <li>
                                Kada daješ, daješ samo bezuvjetno. Sve ostalo je trgovina ili stavljanje drugih u
                                dužnički položaj ili stavljanje sebe u položaj većega.
                            </li>
                            <li>
                                Kada se nešto daje, nije nužno da se isto prima nazad ili da se vraća onome od kojeg je
                                dobiveno. Naprimjer Učitelj daje znanje koje je primio od svog učitelja, učenik prima
                                znanje i vraća poštovanje.
                            </li>
                        </ul>
                    </p>
                </li>
